export default {
    container:
        'relative h-9 mx-auto w-full flex items-center justify-end box-border cursor-pointer rounded text-sm leading-snug outline-none bg-white dark:bg-slate-900 dark:focus:bg-slate-900 border border-slate-300 dark:border-slate-700 dark:focus:border-slate-500',
    containerDisabled: 'cursor-default bg-white',
    containerOpen: 'rounded-b-none border-primary-300 dark:!border-slate-500',
    containerOpenTop: 'rounded-t-none border-primary-300 dark:!border-slate-500',
    containerActive: 'ring ring-primary-200 dark:ring-slate-600 border-primary-300 dark:border-slate-500',
    singleLabel:
    ...
    placeholder:
        'flex items-center h-full absolute left-0 top-0 pointer-events-none bg-transparent leading-snug pl-3.5 text-slate-400 dark:text-slate-600',
    ...
    dropdown:
        'max-h-60 absolute -left-px -right-px bottom-0 transform translate-y-full border border-primary-300 dark:border-slate-500 dark:focus:border-slate-500 -mt-px overflow-y-scroll z-50 bg-white dark:bg-slate-900 flex flex-col rounded-b',
    ...
    groupLabelDisabled: 'bg-white text-slate-300 cursor-not-allowed',
    ...
    noOptions: 'py-2 px-3 text-slate-600 bg-white dark:bg-slate-900 text-left',
    noResults: 'py-2 px-3 text-slate-600 bg-white dark:bg-slate-900 text-left',
    fakeInput:
